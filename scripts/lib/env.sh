...
MY_OS_COLOR_NOTICE="$MY_OS_COLOR_YELLOW"
...
MY_OS_PATH_LOG_ERR=$MY_OS_PATH_TEMPFILES/errors.log
MY_OS_PATH_LOG_INFO=$MY_OS_PATH_TEMPFILES/info.log
MY_OS_PATH_LOG_CMD=$MY_OS_PATH_TEMPFILES/cmd.log
MY_OS_PATH_LOG_WARN=$MY_OS_PATH_TEMPFILES/warn.log
MY_OS_PATH_LOG_NOTICE=$MY_OS_PATH_TEMPFILES/notice.log
MY_OS_PATH_LOG_ALL=$MY_OS_PATH_TEMPFILES/all.log
...
MY_OS_GIT_PATH_BRAVE_PROFILES=~/.config/BraveSoftware
MY_OS_GIT_ARTIFACT_DIR_BROWSER_PROFILES_BRAVE=Brave-Browser
