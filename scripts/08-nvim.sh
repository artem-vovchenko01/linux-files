...
[[ -e ~/.config/nvim/init.lua ]] || { ask "You don't have ~/.config/nvim/init.lua. You might want to rerun config setup script! Run it?" Y "source $CONFIG_SCRIPT"; }

if [[ ! -e "$XDG_DATA_HOME:-$HOME/.local/share}/nvim/site/autoload/plug.vim" ]]; then
  ask "Install vim plug?" Y && {
