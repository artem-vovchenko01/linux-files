...
This file provides guidance to Gemini (Google's coding agent) when working with code in this repository.
...
- If you update this file (`GEMINI.md`), you must also review and update `AGENTS.md` and `CLAUDE.md` in the same change so agent-specific guidance stays aligned.
